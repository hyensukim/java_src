...
public class Stream03 {
	...
	public static void main(String[] args) {
		...
		IntStream stream5 = Arrays.stream(students).mapToInt(Student::getScore);
		stream5.sorted().forEach(System.out::println);
		
		stream5 = Arrays.stream(students).mapToInt(Student::getScore);
		//스트림 통계 요약본 {요소 갯수, 합계, 평균, 최소값, 최대값}
		IntSummaryStatistics stat = stream5.summaryStatistics();
